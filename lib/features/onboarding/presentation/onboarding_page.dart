                ...
                if (step == -1) ...[
                  ...
                  Center(
                    child: TextButton(
                      onPressed: () => toast(
                        context,
                        'Login menyusul. Preview ini menggunakan profil lokal tanpa akun.',
                      ),
                  ...
                  if (step == 2) ...[
                    ...
                    gap(),
                    caption(
                      'Data disimpan di browser perangkat ini. Tidak ada akun, sinkronisasi, atau pengguna lain yang terhubung pada preview.',
                    ),
                  ],
                  if (error != null)
