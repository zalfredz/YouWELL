...
class WebLandingPage extends StatefulWidget {
  const WebLandingPage({super.key, required this.onJoin});
...
class _WebLandingPageState extends State<WebLandingPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
    body: CustomScrollView(
      slivers: [
        SliverToBoxAdapter(
          child: _Hero(onDashboard: _join, onDownload: _download),
        ),
        SliverToBoxAdapter(
        ...
        const SliverToBoxAdapter(child: _WellbeingSection()),
...
class _Hero extends StatelessWidget {
  const _Hero({required this.onDashboard, required this.onDownload});
      ...
      child: Center(
        child: ConstrainedBox(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                _LandingNavigation(onDashboard: onDashboard),
                    ...
                    return compact
                        ...
                        : Row(
                            ...
                            children: [
                              ...
                              const Expanded(flex: 9, child: _PhonePreview()),
                            ],
                          );
                  },
                ),
...
class _LandingNavigation extends StatelessWidget {
  const _LandingNavigation({required this.onDashboard});
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            return wide
                ...
                : Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [copy, const SizedBox(height: 34), principles],
                  );
          },
        ),
      ),
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: const Column(
      ...
      children: [
        ...
        _Principle(
          number: '01',
          text: 'Tidak ada target kaku yang menghukum ritmemu.',
        ),
        _Principle(
          number: '02',
