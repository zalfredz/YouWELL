...
class _DailyCardDrawDialogState extends State<DailyCardDrawDialog> {
  ...
  void initState() {
    super.initState();
    // Enter the draw directly: the daily ritual should spotlight the cards,
    // not make the user read an extra welcome screen first.
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
    ...
    builder: (context, _) {
      ...
      final hasSelectedCard = widget.controller.selectedDailyCard != null;
      return Dialog(
        ...
        child: ConstrainedBox(
          constraints: BoxConstraints(
            maxWidth: 820,
            // The face-down deck is intentionally compact on phones. A
            // revealed 3–5 task card retains room for its task preview.
            maxHeight: compact && !hasSelectedCard ? 470 : 660,
          ),
          child: DecoratedBox(
        ...
        children: [
          Row(
            children: [
              ...
              _DrawPill(label: '2x pilih', color: _aqua),
...
class _FaceDownDeckState extends State<_FaceDownDeck> {
  ...
  Widget build(BuildContext context) => LayoutBuilder(
    builder: (context, _) {
      final compact = MediaQuery.sizeOf(context).width < 600;
      final cardHeight = compact ? 250.0 : 306.0;
      return Column(
        children: [
          Expanded(
            child: Center(
                    ...
                    child: PageView.builder(
                      ...
                      itemBuilder: (context, physicalIndex) {
                        ...
                        return _CarouselCard(
                          ...
                          passed: widget.passedCardIds.contains(
                            widget.cards[cardIndex]['id'].toString(),
                          ),
                          compact: compact,
          ...
          Text(
            '${_page % widget.cards.length + 1} / ${widget.cards.length}',
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: palette.dark.withValues(
                        alpha: selected ? .48 : .15,
                      ),
...
class _FlipRevealCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => TweenAnimationBuilder<double>(
    ...
    builder: (context, progress, _) {
      ...
      final angle = showFront ? math.pi * (1 - progress) : math.pi * progress;
      return Transform(
  ...
  Widget build(BuildContext context) => Center(
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20),
        boxShadow: [
          BoxShadow(color: palette.dark.withValues(alpha: .45), blurRadius: 30),
        ],
      ),
      child: Stack(
        children: [
