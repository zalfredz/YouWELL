...
Widget caption(String text) => Text(
  text,
  style: const TextStyle(color: appMuted, fontSize: 13, height: 1.5),
);
Widget gap([double size = 16]) => SizedBox(height: size);
Widget panel(List<Widget> children, {Color color = appSurface}) => Container(
...
Widget tag(String text, {Color color = appAccent}) => Container(
